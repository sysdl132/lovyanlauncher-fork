...
#include "CBArduinoOTA.h"
#include "CBSDUpdater.h"
#include "CBFSBench.h"
#include "CBWiFiSetting.h"
#include "CBWiFiSmartConfig.h"
...
void drawFrame() {
  ...
  M5.Lcd.drawString("@sysdl132    v1.7.10", 204, 201, 1);
  M5.Lcd.drawString("http://github.com/sysdl132", 204, 211, 1);
}
...
void setup() {
  M5.begin();
  Serial.begin(115200);
  Serial.println("loading console...");
  Serial.println("console started");
  Serial.println("---CONSOLE-V0.1---`");
  Serial.println("[  ok  ]mounted /BIN");
  Serial.println("boot mounted");
  Serial.println("treeview_start");
  Serial.println("system started.");
  Serial.println("0x10000000_done");
  ...
  treeView.setItems(vmi
               ...
               , new MenuItem("Tools", vmi
                 ...
                 , new MenuItem("Style ", callBackStyle, vmi
                   { new MenuItem("FreeSans9pt7b-normalfont", 2)
                   , new MenuItem("Font 2-big font" , 1)
                   , new MenuItem("Font 1-small font", 0)
                   } )
                 } )
               ...
               , new MenuItem("Power", vmi
                 ...
                 , new MenuItemToggle("M5GO Bottom LED", true, callBackFIRELED)
                 , new MenuItem("DeepSleep", callBackDeepSleep)
                 })
#endif
               , new MenuItem("OTA", vmi
                 { new MenuItem("Arduino OTA and password", callBackExec<CBArduinoOTA>)
